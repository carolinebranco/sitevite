    ...
    <div class="p-3 card-body">
      ...
      <ul class="list-group">
        <li class="pt-0 text-sm border-0 list-group-item ps-0">
          <strong class="text-dark">Full Name:</strong> &nbsp; CAROLINEBRANCO
        </li>
        <li class="text-sm border-0 list-group-item ps-0">
          <strong class="text-dark">Mobile:</strong> &nbsp; (55) 999582194
        </li>
        <li class="text-sm border-0 list-group-item ps-0">
          <strong class="text-dark">Email:</strong> &nbsp; CAROLINEBRANCO1@HTOMAIL.COM
        </li>
        <li class="text-sm border-0 list-group-item ps-0">
          <strong class="text-dark">Location:</strong> &nbsp; BRA
        </li>
        <li class="pb-0 border-0 list-group-item ps-0">
          ...
          <a
            ...
            href="javascript:;"
          >
            <i class="fab fa-instagram fa-lg">https://github.com/carolinebranco/sitevite</i>
          </a>
        </li>
      </ul>
    </div>
