        ...
        <table class="table align-items-center mb-0">
          ...
          <tbody>
              ...
              <td>
                <div class="d-flex px-2 py-1">
                  ...
                  <div class="d-flex flex-column justify-content-center">
                    <h6 class="mb-0 text-sm">CAROLINEBRANCO</h6>
                    <p class="text-xs text-secondary mb-0">carolinebranco1@hotmail.com</p>
                  </div>
                </div>
              </td>
              <td>
            ...
            <tr>
              ...
              <td class="align-middle text-center">
                <span class="text-secondary text-xs font-weight-bold">11/01/22</span>
              </td>
              <td class="align-middle">
                <a
                  href="javascript:;"
            ...
            <tr>
              <td>
                <div class="d-flex px-2 py-1">
                  ...
                  <div class="d-flex flex-column justify-content-center">
                    <h6 class="mb-0 text-sm">caroll</h6>
            ...
            <tr>
              <td>
                <div class="d-flex px-2 py-1">
                  ...
                  <div class="d-flex flex-column justify-content-center">
                    <h6 class="mb-0 text-sm">carolinebranco1</h6>
                    <p class="text-xs text-secondary mb-0">carolinebranco1</p>
                  </div>
                </div>
              </td>
              <td>
